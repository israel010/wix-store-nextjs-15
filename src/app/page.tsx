    ...
    <main className="mx-auto max-w-7xl space-y-10 px-5 py-10">
      <div className="flex items-center bg-secondary md:h-96">
        <div className="space-y-7 p-10 text-center md:w-1/2">
          <h1 className="text-3xl font-bold md:text-4xl ">Fill void in your heart</h1>
          <p>
...
async function FeaturedProducts() {
  ...
  return <div className="space-y-5">
    ...
    <div className="flex sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 flex-col gap-4
    ">
...
function LoadingSkeleton() {
  ...
  return (
    ...
    <div className="flex sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 flex-col gap-4 pt-12
    ">
      {
