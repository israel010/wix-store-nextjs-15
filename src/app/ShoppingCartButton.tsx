...
export default function ShoppingCartButton({ initialData }: ShoppingCartButtonProps) {
    ...
    return <>
        <div className="relative">
            <Button variant="ghost" onClick={() => setSheetOpen(true)} size={"icon"}>
                <ShoppingCartIcon />
                <span className="absolute top-0 right-0 size-5 flex items-center justify-center text-xs text-primary-foreground rounded-full bg-primary">{totalQuantity < 10 ? totalQuantity : "9+"}</span>
        ...
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            <SheetContent
                className="flex flex-col sm:max-w-lg h-full "
            >
        ...
        <li className="flex items-center gap-3">
            ...
            <div className="space-y-1.5 text-sm ">
                ...
                >
                    ...
                    <p className="font-bold">{item.productName?.translated || "Iteml"}</p>
                </Link>
                {
