...
export async function queryProducts(wixClient: WixClient, { collectionIds, sort = "last_updated", skip, limit, q, priceMax, priceMin }: QueryProductsFilter) {
...
export async function getRelatedProducts(wixClient: WixClient, productId: string) {
    ...
    const productResult = await wixClient.products.queryProducts().in("_id", productIds).limit(4).find();
